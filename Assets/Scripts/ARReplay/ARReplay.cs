...
namespace ota.ndi
{
    ...
    internal sealed class ARReplay : System.IDisposable
    {
        ...
        public ARReplay()
        {
            ...
            //string path = "E:\\\\iphone_movie\\\\Record_Main_0301_1039_12.mp4";
            string path = "E:\\\\iphone_movie\\\\Record_Main_0608_1953_52.mp4";
            //string path = "D:\\\\tmp\\\\Record_PlaneAndMeshingAR_1201_2132_32.MP4";
            _video = CreateVideoPlayer(path);
            Debug.Log(_video.timeReference);
            _metadata = new MetadataPlayer(path);
            _sharedInstance = this;
        }
